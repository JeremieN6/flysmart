      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mb-8">
            <div>
              ...
              {/* Ancres alignees sur le nouvel ordre des sections.
                  #pricing n existait plus depuis le decoupage : lien mort. */}
              <div className="flex flex-wrap gap-x-8 gap-y-2 text-sm" style={{ color: "var(--steel)" }}><a href="#apercu" className="hover:opacity-80 transition-opacity">Démo</a><a href="#pour-qui" className="hover:opacity-80 transition-opacity">Pour qui</a><a href="#problemes" className="hover:opacity-80 transition-opacity">Problèmes</a><a href="#tarifs" className="hover:opacity-80 transition-opacity">Tarifs</a><a className="hover:opacity-80 transition-opacity" href="/tarifs">Page tarifs</a><a href="#faq" className="hover:opacity-80 transition-opacity">FAQ</a><a href="#contact-demo" className="hover:opacity-80 transition-opacity">Demander une démo</a><a className="hover:opacity-80 transition-opacity" href="/analyse">Analyser un vol</a></div>
        </div>
