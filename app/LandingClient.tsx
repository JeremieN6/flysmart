                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      ...
                      style={{ color: "var(--steel)" }}>Nom</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-medium uppercase tracking-widest" 
                      style={{ color: "var(--steel)" }}>Email</label>
                      <input
                        type="email"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-medium uppercase tracking-widest" 
                      style={{ color: "var(--steel)" }}>Entreprise / Structure *</label>
                      <input required placeholder="Agence Voyages etc." className="w-full rounded-xl px-4 py-3.5 text-sm" type="text"style={{background: "rgba(8, 12, 24, 0.6)", border: "1px solid rgba(107, 127, 168, 0.15)", color: "var(--cream)", outline: "none", transition: "border-color 0.2s, box-shadow 0.2s"}} /></div><div className="flex flex-col gap-2">
                        <label className="text-xs font-medium uppercase tracking-widest" style={{ color: "var(--steel)" }}>Type de structure *</label><select required className="w-full rounded-xl px-4 py-3.5 text-sm appearance-none cursor-pointer" style={{background: "rgba(8, 12, 24, 0.6)", border: "1px solid rgba(107, 127, 168, 0.15)", color: "var(--steel)", outline: "none", transition: "border-color 0.2s, box-shadow 0.2s"}}><option value="" style={{background: "rgb(13, 20, 38)"}}>Choisir...</option><option value="agence" style={{background: "rgb(13, 20, 38)"}}>🏢 Agence de voyage</option><option value="ce" style={{background: "rgb(13, 20, 38)"}}>🏭 Comité d'entreprise</option><option value="influenceur" style={{background: "rgb(13, 20, 38)"}}>✈️ Blogueur / Influenceur voyage</option><option value="autre" style={{background: "rgb(13, 20, 38)"}}>Autre</option></select></div></div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-medium uppercase tracking-widest" 
                      style={{ color: "var(--steel)" }}>Site web</label>
                    <input
                      type="url"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-medium uppercase tracking-widest" 
                      style={{ color: "var(--steel)" }}>Message</label>
                    <textarea
                      rows={4}
                  ...
                  <p className="text-center text-xs mt-4" style={{ color: "var(--steel)" }}>Ou intégrez directement — <a href="/tarifs" 
                  style={{ color: "var(--amber)" }}>voir les plans</a></p>
                </form>
              </Reveal>
            ) : (
              <Reveal>
                ...
                >
                  ...
                  <p className="font-semibold text-xl mb-2" style={{ color: "var(--cream)" }}>Demande envoyée !</p>
