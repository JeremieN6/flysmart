...
<footer class="p-4 bg-gray-100 md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">        
        ...
        <p class="my-6 text-gray-500 dark:text-gray-400">FlySmart™ – votre allié pour acheter au meilleur prix.</p>
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a
                class="hover:underline ">FlySmart™</a>. <br> <br> Site web réalisé avec 💖 par <a href="https://jeremiecode.fr">SnapCode™ Agency</a> • All Rights Reserved. </span>
    </div>
</footer>
<!-- Footer -->
